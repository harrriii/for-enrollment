          ...
          <div class="container mt-4" style=" background: #061325 !important;">
            ...
            <div class="row shadow-sm py-lg-2 py-2 px-0" style="border-radius:6px; background:#0E1C2F!important;">
              ...
              <div class="col-lg-5 col-8 text-right " style="font-size:12pt;">
                ...
                <button type="button" class="btn btn-sm pl-0 text-white " data-toggle="tooltip" data-placement="bottom" title="Add" style=" font-size:9pt; background:#061325!important; font-weight:500; height:29px; width:85px; box-shadow: -1px 8px 51px -3px rgba(0,0,0,0.71);"><i class="bi bi-funnel px-1" style="font-size: 11pt;"></i> Filter</button>
