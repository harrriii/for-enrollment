          ...
          <div class="container box-1 mt-4 pt-3 pb-2 bg-white" style="border-radius:10px;box-shadow: 0px 3px 13px -7px rgb(104, 104, 104);">
            ...
            <div class="row">
              ...
              <div class="col pl-4">
                ...
                <label style="font-size:10pt;">Rows </label>
          ...
          <div class="container box-1 mt-4 bg-white" style="border-radius:10px;box-shadow: 0px 3px 13px -7px rgb(104, 104, 104);">
            ...
            <div class="row">
              ...
              <div class="col-lg-7 pt-3 pl-4 pb-0 mb-0 px-2 " style="font-size:12pt; color:#575656;" >
                ...
                <label class="font-weight-bold">Rows</label>

              </div>

              <div class="col-lg-5 pt-3 pl-4 pr-4 pb-0 text-right " style="font-size:12pt;">

                <button type="button" class="btn btn-sm p-1" id="btn_add" 
                
                fmi= "{{$formId}}"

                pni= "{{$panelId}}"

                data-toggle="tooltip" data-placement="bottom" title="Add" style=" font-size:9pt; height:25px; width:25px; border-radius:20px;color:#7A353C; box-shadow: 1px 1px 11px -7px rgb(104, 104, 104);"><i class="fas fa-plus"></i></button>
                        ...
                        @foreach ($rows as $row)
                          ...
                          <tr >
                            ...
                            <td class="text-center">
                              ...
                              <a class="a_icon show" fi="{{$formId}}" pi="{{$panelId}}" ri="{{$row->id}}"> <i data-feather="eye" class=" icon"></i></a>
...
@section('script')
  ...
  @include('inc\js\dashboard\developer\rows') 
